...
for(t in c("Phylum","Class","Order","Family","Genus")){
  ...
  #rank rather than assumed to always align, since the original authors' cbind(t1_norm,meta)
  #pattern only ever worked because none of their 4 cohorts had a sample this low.
